...
MY_CPP    = $(HODORFS)/HodorFS.cpp $(HODORFS)/BufferManager.cpp $(QUERYPARSER)/QueryParser.cpp $(QUERYPARSER)/JoinTable.cpp $(QUERYPARSER)/QueryParserHelper.cpp $(SRC)/HodorDB.cpp $(SRC)/ConsoleReader.cpp $(SRC)/Helper.cpp
